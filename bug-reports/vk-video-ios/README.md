# VK Video on iOS Bug Reports

These reports document field-observed media playback behavior on VK Video pages opened on iOS. Movie titles, search history, account information, page URLs, and other personal browsing data are excluded.
